...
**Important:** This project serves as the Final Project for this course.
...
- You must clearly explain your work and demonstration
...
Organize your GitHub repository like this:
...
- [ ] **Scenario Selected:** Choose from A–E (or get custom scenario approved)
- [ ] **Team Formed:** 2–3 members identified
- [ ] **Architecture Diagram:** Created with all resources, connections, security boundaries, and optimizations
- [ ] **Deployment Method:** Method A (Code) or Method B (GUI) chosen
- [ ] **Cloud Optimizations:** At least 2 selected and implemented
- [ ] **Cost Report:** Generated with Azure Pricing Calculator screenshot
- [ ] **Video Recorded:** 10–15 minutes, all members speaking, uploaded to YouTube as unlisted
- [ ] **Repository Structure:** Organized according to Section 5
- [ ] **CHANGELOG.md:** Maintained with regular, dated entries from all members
- [ ] **README.md:** Includes team members, video link, and demo URL
- [ ] **GitHub Commit History:** Shows equal, regular contributions from all members
- [ ] **Resources Deleted:** Post-submission cleanup to avoid charges

---

*Good luck with your final project! Remember: focus on architecture and cloud principles, keep the application logic simple, and collaborate effectively.*